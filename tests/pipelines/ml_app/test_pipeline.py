...
from kedro_mlflow_tutorial.pipelines.ml_app import create_pipeline as create_ds_pipeline
from kedro_mlflow_tutorial.pipelines.ml_app.nodes import split_data
...
def test_data_science_pipeline(caplog, dummy_data, dummy_parameters):
    ...
    catalog.add_feed_dict(
        {
            "spaceflight_primary_table" : dummy_data,
